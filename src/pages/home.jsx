...
function Home() {
    return (
        <div className="w-full h-full block sm:flex sm:flex-row items-center justify-center gap-[5rem] font-mono overflow-hidden mt-[2rem] sm:mt-[10rem] ">
            <div className="image w-full h-60 sm:w-[33rem] sm:h-[33rem] flex-shrink-0 active:scale-110 transition-transform eas-in-out duration-500 flex items-center justify-center">
                <img src={profile} alt="" className="h-full w-60 sm:w-full rounded-4xl object-ceover" />
            </div>
            <div className="flex flex-col items-center justify-center mt-5 sm:mt-0">
                ...
                <div className="mt-[2rem] flex flex-col items-center justify-center w-full sm:w-[30rem] max-w-full">
            ...
            <div className="block sm:hidden overflow-y-hidden w-full">
                <Resume className="overflow-y-hidden h-full" />
            </div>
        </div>
    )
}
